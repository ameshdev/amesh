 ...
 *
 * `signerEph` is the ephemeral pub key that the peer signing this message
 * put on the wire; `verifierEph` is the one it received. The verifier
 * reconstructs the same transcript using what IT saw on the wire, with the
 * roles swapped.
 */
