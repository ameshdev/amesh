...
<div class="mx-auto max-w-2xl px-6 pb-20">
	...
	<section class="py-6">
		<div class="rounded-lg border border-zinc-800 p-4" style="background:#0C0C0E">
			<pre class="font-mono text-[13px] leading-relaxed text-zinc-400"><span class="text-zinc-500">Pairing (~30s):</span>  Device A  <span class="text-emerald-400">&lt;-WS-&gt;</span>  Relay  <span class="text-emerald-400">&lt;-WS-&gt;</span>  Device B
