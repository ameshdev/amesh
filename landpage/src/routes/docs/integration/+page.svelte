	...
	<section class="py-8">
		...
		<div class="mt-4 space-y-4">
			<div class="rounded-lg border border-zinc-800 p-4" style="background:#0C0C0E">
				...
				<pre class="font-mono text-[13px] leading-relaxed text-zinc-400">Your Server  <span class="text-emerald-400">&lt;--WebSocket--&gt;</span>  Relay  <span class="text-emerald-400">&lt;--WebSocket--&gt;</span>  Client
...
<span class="text-zinc-600">The relay can be shut down after this.</span></pre>
			...
			<div class="rounded-lg border border-zinc-800 p-4" style="background:#0C0C0E">
				...
				<pre class="font-mono text-[13px] leading-relaxed text-zinc-400">Client  <span class="text-emerald-400">----HTTP + AuthMesh header----&gt;</span>  Your Server
